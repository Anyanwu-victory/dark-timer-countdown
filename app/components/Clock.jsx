...
const Timer = () => {
    ...
    useEffect(() => {
        // JavaScript logic extracted and adapted to React
        const els = {
          s: initElements('s'),
          m: initElements('m'),
          h: initElements('h'),
      ...
      return (
        <div id="app" className="w-[100%] h-[100%] flex mt-[15rem] justify-center items-center">
          <div className="flip-clock-container flex justify-center items-center text-8xl leading">
